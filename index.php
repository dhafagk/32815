...
<body>
            ...
            <div class="row">
                <div class="about-heading">
                    ...
                    <p><form method="post" action="">
                        ...
                        <button class="download"><a href="https://drive.google.com/file/d/<?php echo $original_id;?>" style="color:inherit">CONVERT TO GOOGLE DRIVE</a></button>
                        </form></p>
                </div>
            </div>
        </div>
    ...
    <footer class="footer text-center">
        <p>Copyright: &copy; <a href="#">Kamisama</a> | All rights reserved</p>
    </footer>
